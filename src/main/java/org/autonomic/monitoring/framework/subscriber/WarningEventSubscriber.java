...
public class WarningEventSubscriber implements StatementSubscriber {
	...
	public String getStatement() {
		...
		String warningEventExpression = "select * from ResponseTimeEvent " + "match_recognize ( "
				+ "       measures A as temp1, B as temp2, C as temp3, D as temp4, E as temp5  " + "       pattern (A B C D E) " + "       define "
				+ "               A as A.responseTime < " + CDataConstant.RESPONSE_TIME_THRESHOLD + ", " + "               B as B.responseTime > "
				+ CDataConstant.RESPONSE_TIME_THRESHOLD + ", " + "               C as C.responseTime > " + CDataConstant.RESPONSE_TIME_THRESHOLD + ", "
				+ "               D as D.responseTime > " + CDataConstant.RESPONSE_TIME_THRESHOLD + ", " + "               E as E.responseTime < "
				+ CDataConstant.RESPONSE_TIME_THRESHOLD + ")";
	...
	public void update(Map<String, ResponseTimeEvent> eventMap) {
		...
		sb.append("***************************************");
		sb.append("\n* [ALERT] : WARNING VIOLATION DETECTED! ");
